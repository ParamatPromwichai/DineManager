...
export default function MenuDetailPage() {
  ...
  return (
    <div className="bg-blue-50 dark:bg-slate-900 font-sans pb-6 transition-colors">
      ...
      {/* --- ตะกร้า (Cart Overlay) --- */}
      {cart.length > 0 && (
        <div className="fixed bottom-[72px] left-4 right-4 mx-auto max-w-[800px] bg-white dark:bg-slate-800 rounded-3xl p-4 shadow-xl border border-blue-100 dark:border-slate-700 z-[90] transition-colors">
