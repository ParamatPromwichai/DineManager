        ...
        <div className={styles.contactContainer}>
          ...
          <div className={styles.contactGrid}>
            <div className={styles.contactItem}>
              ...
              <p className={styles.contactValue}>080-xxx-xxxx</p>
            </div>
            ...
            <div className={styles.contactItem}>
              ...
              <p className={styles.contactValue}>contact@dinemanager.com</p>
            </div>
            ...
            <div className={styles.contactItem}>
              ...
              <p className={styles.contactValue}>DineManager Official</p>
            </div>
          </div>
        </div>
      </section>
